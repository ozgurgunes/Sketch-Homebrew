...
export function ArtboardChanged() {
...
export function ArrangeArtboards() {
...
export function Duplicate() {
  ...
  if (anArtboardIsSelected()) {
    ArrangeArtboards()
  }
}

export function LayersMoved () {
...
export function ResizeArtboardToFit(){
...
const anArtboardIsSelected = function(){

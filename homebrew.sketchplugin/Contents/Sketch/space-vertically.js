...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  if (selection.length <= 1) {
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Space Vertically: Please select at least 2 layers.");
  } else {
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.getInputFromUser("Vertical Spacing (px):", {
      initialValue: 0
    }, function (err, value) {
      if (err) {
        ...
        sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message("Vertical Spacing: " + value + " px");
      }
    });
  }
});
